...
class GestionSimulation:
    ...
    def OpenSettings(self) :
        if self.WindowSettingState == False :
            ...
            entree1 = Spinbox(newWindow, textvariable=var1, from_=10, to=100, width=10, increment = 10)
            ...
            entree2 = Spinbox(newWindow, textvariable=var2, from_=0, to=100, width=10, increment = 10)
            ...
            entree3 = Spinbox(newWindow, textvariable=var3, from_=30, to=100, width=10, increment = 10)
            ...
            entree4 = Spinbox(newWindow, textvariable=var4, from_=30, to=100, width=10, increment = 10)
            ...
            entree5 = Spinbox(newWindow, textvariable=var5, from_=30, to=100, width=10, increment = 10)
